...
data_city.to_csv("List_Cities_States.csv")


list_city = list_city_temp
list_state = list_state_temp 

for i in range(0,len(list_state)):
    if list_state[i] != 'WI':
        list_state_temp.append(list_state[i])
        list_city_temp.append(list_city[i])
